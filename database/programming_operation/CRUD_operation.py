''' this scripts has CRUD Operation on Database'''
import sqlite3
import os
...
c.execute('''create table student(ID integer primary key, NAME varchar(15), \
            AGE integer, SEX varchar(15), GRADE integer)''')
...
c.execute('''create table teacher(ID varchar(8) primary key,\
            NAME varchar(15), AGE integer, SEX varchar(15), SUBJECT varchar(15))''')
